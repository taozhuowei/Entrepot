 ...
 * 数组转树 
 * @param arr 数组 
 * @param rootKeyValue 根节点的key的值 默认0
 * @param nodeKeyName 节点的唯一id属性名 默认id
 * @param parentKeyName 节点的父节点标识属性名 默认pid
 * @return res 树形结构
 * */
export default function arrayToTree(arr, rootKeyValue, nodeKeyName, parentKeyName) {
    rootKeyValue = rootKeyValue || 0;
